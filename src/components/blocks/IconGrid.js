                ...
                <div className="icon-grid container mx-auto w-full flex-none grid grid-cols-2 md:grid-cols-8 grid-rows-2 gap-y-10 pt-10">                
                    {
                        blok.items.map((item, index) => {
                            ...
                            <div key={index}>
                                ...
                                <div className="fixed top-0 left-0 right-0 bottom-0 w-3/4 h-3/4  py-16 m-auto modal opacity-0 z-20 bg-white rounded-xl shadow-2xl scale-0 transition transform-gpu duration-100">
